...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/TheCipherX/cipher-ig-tools.git
	* cd cipher-ig-tools
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/TheCipherX/cipher-ig-tools.git)
	* Extract File cipher-ig-tools and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the cipher-ig-tools folder!!!)
...
## SPECIAL THANKS TO:
	* Code by CipherX (citykhalith@gmail.com)
